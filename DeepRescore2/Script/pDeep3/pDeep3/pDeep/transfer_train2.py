...
from cmd.tune_and_predict import tune_and_predict

# train_folder = sys.argv[1]
# test_folder = sys.argv[2]

train_Vls = ("/data/xyi/DeepRescore/PredictSpectrum/psmLabel/data/Tune", 40, "Velos")
...
test_Vls = ("/data/xyi/DeepRescore/PredictSpectrum/psmLabel/data/Predict", 40, "Velos")
...
param.model = "/data/xyi/DeepRescore/PredictSpectrum/pDeep3/pDeep3/pDeep/tmp/model/pretrain-180921-modloss-mod8D.ckpt"
...
pdeep.SaveModel("/data/xyi/DeepRescore/PredictSpectrum/psmLabel/data/model/pretrain-phos.ckpt")
