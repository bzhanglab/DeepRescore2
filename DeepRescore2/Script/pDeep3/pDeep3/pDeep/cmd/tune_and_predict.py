...
def run(pDeep_cfg, peptide_list = None):
    ...
    '''
    if type(pDeep_cfg) is not pDeepParameter: 
...
if __name__ == "__main__":
    #pDeep_cfg = '/data/xyi/DeepRescore/PredictSpectrum/pDeep3/pDeep3/pDeep/tmp/predict/pDeep-tune.cfg'
    #a = load_param(pDeep_cfg)
