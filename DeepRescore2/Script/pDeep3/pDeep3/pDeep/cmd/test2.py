...
model_folder = '/data/xyi/DeepRescore/PredictSpectrum/psmLabel/data/model'
model_name = 'pretrain-phos.ckpt'
...
QEHO = "/data/xyi/DeepRescore/PredictSpectrum/psmLabel/data/Predict"
